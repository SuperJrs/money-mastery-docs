/* DLD_controle_de_gastos: */

CREATE TABLE CONTA (
    cpf_proprietario        BIGINT(11) NOT NULL,
...
CREATE TABLE SAIDA (
    ...
    categoria           ENUM('LAZER', 'ALIMENTACAO', 'SAUDE', 'MORADIA',  'TRANSPORTE', 'EDUCACAO', 'OUTRO') NOT NULL,
    descricao_saida     VARCHAR(100),
    forma_pagamento     ENUM('CREDITO', 'DEBITO', 'PIX', 'DINHEIRO', 'RESERVA', 'EMPRESTIMO') NOT NULL,
...
CREATE TABLE ENTRADA (
    ...
    origem              ENUM('PIX', 'SALARIO', 'EMPRESTIMO', 'RESERVA', 'OUTRO') NOT NULL,
